...
class MyFrame1 ( wx.Frame ):
    ...
    def __init__( self, parent ):
        ...
        dashboardIcon=wx.Bitmap("e:/SHRINIVAS/KGP/SocialDistancingUIDesktop/ui_elements/dashboard.png",wx.BITMAP_TYPE_ANY)
        self.m_bpButton5 = wx.BitmapButton( self, wx.ID_ANY, dashboardIcon, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW )
        bSizer4.Add( self.m_bpButton5, 0, wx.ALL, 5 )
        
        configurationIcon=wx.Bitmap("e:/SHRINIVAS/KGP/SocialDistancingUIDesktop/ui_elements/config.png",wx.BITMAP_TYPE_ANY)
        self.m_bpButton6 = wx.BitmapButton( self, wx.ID_ANY, configurationIcon, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW )
        bSizer4.Add( self.m_bpButton6, 0, wx.ALL, 5 )
        
        calibrationIcon=wx.Bitmap("e:/SHRINIVAS/KGP/SocialDistancingUIDesktop/ui_elements/Calibration.png",wx.BITMAP_TYPE_ANY)
        self.m_bpButton6 = wx.BitmapButton( self, wx.ID_ANY, calibrationIcon, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW )
        bSizer4.Add( self.m_bpButton6, 0, wx.ALL, 5 )
        
        helpIcon=wx.Bitmap("e:/SHRINIVAS/KGP/SocialDistancingUIDesktop/ui_elements/help.png",wx.BITMAP_TYPE_ANY)
        self.m_bpButton7 = wx.BitmapButton( self, wx.ID_ANY, helpIcon, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW )
        ...
        UserIcon=wx.Bitmap("e:/SHRINIVAS/KGP/SocialDistancingUIDesktop/ui_elements/user.png",wx.BITMAP_TYPE_ANY)
        self.m_bpButton8 = wx.BitmapButton( self, wx.ID_ANY, UserIcon, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW )
        ...
        self.m_button1 = wx.Button( self.m_panel1, wx.ID_ANY, u"+ Add New Camera", wx.DefaultPosition, wx.Size( -1,34 ), 0 )
        ...
        self.m_button2 = wx.Button( self.m_panel1, wx.ID_ANY, u"Stop All", wx.DefaultPosition, wx.Size( -1,34 ), 0 )
        ...
        self.m_button3 = wx.Button( self.m_panel1, wx.ID_ANY, u"Start All", wx.DefaultPosition, wx.Size( -1,34 ), 0 )
    ...
    def stopAll(self,event,sizer):
        ...
        for i in range(1,numberOfItems):
            sizer.Children[11*i+9].Window.SetBitmap(wx.Bitmap("e:/SHRINIVAS/KGP/SocialDistancingUIDesktop/ui_elements/play.png",wx.BITMAP_TYPE_ANY))
    ...
    def startAll(self,event,sizer):
        numberOfItems=int(len(sizer.Children)/10)
        for i in range(1,numberOfItems):
            sizer.Children[11*i+9].Window.SetBitmap(wx.Bitmap("e:/SHRINIVAS/KGP/SocialDistancingUIDesktop/ui_elements/pause.png",wx.BITMAP_TYPE_ANY))
    ...
    def makeOneRow(self,fgSizer,m_scrolledWindow1,InputData,name,canEdit,isPause,status):
        m_textCtrl0 = wx.TextCtrl( m_scrolledWindow1, wx.ID_ANY, str(self.numberOfCamera), wx.DefaultPosition, wx.Size( -1,-1 ), style=wx.TE_CENTER,name=name+"_number" )
        ...
        m_textCtrl1 = wx.TextCtrl( m_scrolledWindow1, wx.ID_ANY, InputData[0], wx.DefaultPosition, wx.Size( -1,-1 ), style=wx.TE_CENTER,name=name+"_number" )
        ...
        m_textCtrl2 = wx.TextCtrl( m_scrolledWindow1, wx.ID_ANY, InputData[1], wx.DefaultPosition, wx.DefaultSize, style=wx.TE_CENTER ,name=name+"_alias" )
        ...
        m_textCtrl3 = wx.TextCtrl( m_scrolledWindow1, wx.ID_ANY, InputData[2], wx.DefaultPosition, wx.Size( -1,-1 ), style=wx.TE_CENTER,name=name+"_cameraID"  )
        ...
        m_textCtrl4 = wx.TextCtrl( m_scrolledWindow1, wx.ID_ANY, InputData[3], wx.DefaultPosition, wx.DefaultSize, style=wx.TE_CENTER,name=name+"_camURL"  )
        ...
        m_textCtrl5 = wx.TextCtrl( m_scrolledWindow1, wx.ID_ANY, InputData[4], wx.DefaultPosition, wx.DefaultSize, style=wx.TE_CENTER,name=name+"_password"  )
        ...
        m_button81 = wx.Button( m_scrolledWindow1, wx.ID_ANY, InputData[5], wx.DefaultPosition, wx.Size( -1,34 ), 0,name=name+"_edit")
        ...
        m_button82 = wx.Button( m_scrolledWindow1, wx.ID_ANY, u"Delete", wx.DefaultPosition, wx.Size( -1,34 ), 0,name=name+"_delete")
        ...
        if(status==2):
            statusIcon=wx.Bitmap("e:/SHRINIVAS/KGP/SocialDistancingUIDesktop/ui_elements/status-green.png",wx.BITMAP_TYPE_ANY)
        elif(status==1):
            statusIcon=wx.Bitmap("e:/SHRINIVAS/KGP/SocialDistancingUIDesktop/ui_elements/status-yellow.png",wx.BITMAP_TYPE_ANY)
        else:
            statusIcon=wx.Bitmap("e:/SHRINIVAS/KGP/SocialDistancingUIDesktop/ui_elements/status-red.png",wx.BITMAP_TYPE_ANY)
        m_bpButton7 = wx.BitmapButton( m_scrolledWindow1, wx.ID_ANY, statusIcon, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW )
        fgSizer.Add( m_bpButton7, 0, wx.ALIGN_CENTER|wx.ALL, 0 )
        
        if(isPause):
            controlIcon=wx.Bitmap("e:/SHRINIVAS/KGP/SocialDistancingUIDesktop/ui_elements/play.png",wx.BITMAP_TYPE_ANY)
        else:
            controlIcon=wx.Bitmap("e:/SHRINIVAS/KGP/SocialDistancingUIDesktop/ui_elements/pause.png",wx.BITMAP_TYPE_ANY)
        m_bpButton7 = wx.BitmapButton( m_scrolledWindow1, wx.ID_ANY, controlIcon, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW,name=name+"_control" )
    ...
    def controlButtonClick(self,event):
        ...
        if(data[cameraIndex]["cameraStatus"]["isPaused"]):
            window.SetBitmap(wx.Bitmap("e:/SHRINIVAS/KGP/SocialDistancingUIDesktop/ui_elements/play.png",wx.BITMAP_TYPE_ANY))
        else:
            window.SetBitmap(wx.Bitmap("e:/SHRINIVAS/KGP/SocialDistancingUIDesktop/ui_elements/pause.png",wx.BITMAP_TYPE_ANY))
